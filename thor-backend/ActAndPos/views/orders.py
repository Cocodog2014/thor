...
from ..serializers import AccountSummarySerializer, OrderSerializer, PositionSerializer
from .accounts import get_active_account


@api_view(["GET"])
def activity_today_view(request):
    """GET /api/activity/today?account_id=123 – intraday order + position snapshot."""
