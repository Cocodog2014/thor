...
urlpatterns = [
    ...
    path('api/', include('FutureTrading.urls')), # Future Trading APIs (base prefix)
    path('api/futures/', include('FutureTrading.urls')), # Alias prefix to match docs/frontend expecting /api/futures/
