# Generated by hand to move volume next to ask_size
...
BEGIN
    ...
    EXECUTE '
        CREATE TABLE "FutureTrading_marketsession_tmp" (
            ...
            CONSTRAINT ft_msession_tmp_cymdf_key_38 UNIQUE (country, year, month, date, future)
        );
    ';

    col_list := 'id, session_number, year, month, date, day, captured_at, country, future, country_future, weight, '
        || 'bhs, wndw, session_bid, bid_size, last_price, session_ask, ask_size, volume, '
        ...
        || 'vwap, spread, entry_price, target_high, target_low, weighted_average, instrument_count, '
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("FutureTrading", "0037_remove_marketsession_close_ask_and_more"),
    ]
