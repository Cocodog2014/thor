...
BEGIN
    ...
    CREATE TABLE "FutureTrading_marketsession_tmp" (
        ...
        CONSTRAINT ft_msession_tmp_cymdf_key_26 UNIQUE (country, year, month, date, future)
    );

    col_list := 'id, session_number, year, month, date, day, captured_at, country, future, country_future, weight, '
        || 'bhs, wndw, country_future_wndw_total, strong_buy_worked, strong_buy_worked_percentage, '
