# Generated by Django 5.2.6 on 2025-11-19 20:37
...
BEGIN
    ...
    CREATE TABLE "FutureTrading_marketsession_tmp" (
        ...
        CONSTRAINT futuretrading_marketsession_tmp_country_year_month_date_future_key UNIQUE (country, year, month, date, future)
    );
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("FutureTrading", "0019_add_wndw_field"),
    ]
