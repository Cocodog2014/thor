...
BEGIN
    ...
    CREATE TABLE "FutureTrading_marketsession_tmp" (
        ...
        CONSTRAINT ft_msession_tmp_cymdf_key_52 UNIQUE (country, year, month, date, future)
    );

    col_list := 'id, session_number, year, month, date, day, captured_at, country, future, country_future, '
        || 'weight, bhs, wndw, country_future_wndw_total, bid_price, bid_size, last_price, ask_price, ask_size, '
        || 'entry_price, target_high, target_low, volume, change, change_percent, vwap, spread, session_close, '
        || 'session_open, open_vs_prev_number, open_vs_prev_percent, day_24h_low, day_24h_high, range_high_low, '
        || 'range_percent, week_52_low, week_52_high, week_52_range_high_low, week_52_range_percent, '
        || 'weighted_average, instrument_count, strong_buy_worked, strong_buy_worked_percentage, '
        || 'strong_buy_didnt_work, strong_buy_didnt_work_percentage, buy_worked, buy_worked_percentage, '
        || 'buy_didnt_work, buy_didnt_work_percentage, hold, hold_percentage, strong_sell_worked, '
        || 'strong_sell_worked_percentage, strong_sell_didnt_work, strong_sell_didnt_work_percentage, '
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("FutureTrading", "0051_alter_marketsession_bid_price_and_more"),
        ("FutureTrading", "0051_remove_marketsession_timestamps"),
    ]
