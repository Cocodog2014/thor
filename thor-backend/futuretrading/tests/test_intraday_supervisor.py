...
class IntradayMarketSupervisorTests(TestCase):
    ...
    def test_manual_metric_flow_without_threads(self):
        ...
        self.assertTrue(Decimal("0.9523") < ym.market_close_percentage_high < Decimal("0.9525"))
        self.assertTrue(Decimal("2.9702") < ym.market_close_percentage_low < Decimal("2.9704"))
        self.assertTrue(Decimal("1.9047") < es.market_close_percentage_high < Decimal("1.9049"))
        self.assertTrue(Decimal("2.4875") < es.market_close_percentage_low < Decimal("2.4877"))
        self.assertTrue(Decimal("0.6451") < total.market_close_percentage_high < Decimal("0.6453"))
        self.assertTrue(Decimal("1.9866") < total.market_close_percentage_low < Decimal("1.9868"))
