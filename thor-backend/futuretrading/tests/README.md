...
& C:/Python313/python.exe manage.py test FutureTrading.tests
```
...
$env:DJANGO_SETTINGS_MODULE='thor_project.test_settings'
& C:/Python313/python.exe manage.py test FutureTrading.tests.test_market_metrics

# Supervisor tests (1 test)
$env:DJANGO_SETTINGS_MODULE='thor_project.test_settings'
& C:/Python313/python.exe manage.py test FutureTrading.tests.test_intraday_supervisor
```
...
$env:DJANGO_SETTINGS_MODULE='thor_project.test_settings'
& C:/Python313/python.exe -m coverage run --source='FutureTrading' manage.py test FutureTrading.tests
...
jobs:
  test:
    ...
    - name: Run tests with coverage
      ...
      run: |
        cd thor-backend
        python -m coverage run --source='FutureTrading' manage.py test FutureTrading.tests
