"""Market open grading logic for sessions.

This module holds the grading pass used by heartbeat and API wrappers.
"""
...
grade_interval_seconds = float(os.getenv("THOR_GRADE_INTERVAL_SEC", grade_interval_seconds))
