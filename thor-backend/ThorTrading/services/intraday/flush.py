...
# MarketIntraday is deprecated as a sink; keep import only to avoid hard removal during transition.
...
def flush_closed_bars(routing_key: str, batch_size: int = 500, max_batches: int = 20) -> int:
    ...
    MarketIntraday is deprecated as a sink; we now treat InstrumentIntraday as the single
    source of truth for 1m bars. Session/country projections should be derived downstream.
