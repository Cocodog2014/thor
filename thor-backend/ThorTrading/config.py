"""
ThorTrading configuration

Data source configuration for the ThorTrading futures dashboard. Keeping
these settings version controlled ensures reproducible local dev setups.
"""

# ============================================================================
# TOS Excel RTD Data Source
# ============================================================================
# ThorTrading reads live futures data from TOS Excel RTD
