...
class MarketOpenCaptureService:
    ...
    def create_session_for_total(
        ...
        try:
            data["instrument_count"] = int(composite.get("instrument_count") or len(composite.get("contributions") or {}))
        except Exception:
    ...
    def capture_market_open(self, market: Market, *, session_number: int | None = None):
        from ThorTrading.GlobalMarketGate.global_market_gate import open_capture_allowed, session_tracking_allowed
