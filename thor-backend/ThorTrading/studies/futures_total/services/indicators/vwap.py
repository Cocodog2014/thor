...
class VwapService:
    ...
    def _fetch_rows(self, symbol: str, start: datetime | None = None, end: datetime | None = None) -> QuerySet[VwapMinute]:
    ...
    def calculate_vwap(self, symbol: str, start: datetime | None = None, end: datetime | None = None) -> VwapResult:
    ...
    def calculate_rolling_vwap(self, symbol: str, lookback_minutes: int, now_dt: datetime | None = None) -> Optional[Decimal]:
        ...
        start = now_dt - timedelta(minutes=lookback_minutes)
