# Generated by Django 5.2.6 on 2025-11-19 21:15
...
BEGIN
    ...
    CREATE TABLE "FutureTrading_marketsession_tmp" (
        ...
        CONSTRAINT ft_msession_tmp_cymdf_key_21 UNIQUE (country, year, month, date, future)
    );
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("FutureTrading", "0020_marketsession_country_future"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="marketsession",
            name="strong_buy_didnt_worked_percentage",
            field=models.DecimalField(
                blank=True,
                decimal_places=4,
