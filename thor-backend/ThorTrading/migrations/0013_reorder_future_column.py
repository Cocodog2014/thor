...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('FutureTrading', '0012_marketopensession_future'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            sql="""
                CREATE TABLE "FutureTrading_marketopensession_new" (
                ...
                INSERT INTO "FutureTrading_marketopensession_new" 
                SELECT 
                ...
                DROP TABLE "FutureTrading_marketopensession" CASCADE;
                
                ALTER TABLE "FutureTrading_marketopensession_new" 
                RENAME TO "FutureTrading_marketopensession";
                
                -- Recreate foreign key constraints from FutureSnapshot
                ALTER TABLE "FutureTrading_futuresnapshot"
                ADD CONSTRAINT "FutureTrading_futures_session_id_fkey"
                FOREIGN KEY ("session_id") REFERENCES "FutureTrading_marketopensession"("id")
                ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
                
                -- Recreate foreign key constraints from FutureCloseSnapshot
                ALTER TABLE "FutureTrading_futureclosesnapshot"
                ADD CONSTRAINT "FutureTrading_futuresclose_session_id_fkey"
                FOREIGN KEY ("session_id") REFERENCES "FutureTrading_marketopensession"("id")
                ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
            """,
