...
REVERSE_SQL = r"""
ALTER TABLE "FutureTrading_marketsession" DROP COLUMN IF EXISTS change_percent;
ALTER TABLE "FutureTrading_marketsession" DROP COLUMN IF EXISTS change;
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("FutureTrading", "0032_reorder_last_price_after_wndw"),
    ]
