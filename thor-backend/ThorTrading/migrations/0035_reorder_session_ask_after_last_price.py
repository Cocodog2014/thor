# Generated by hand to reorder session_ask adjacent to last_price
...
BEGIN
    ...
    EXECUTE '
        CREATE TABLE "FutureTrading_marketsession_tmp" (
            ...
            CONSTRAINT ft_msession_tmp_cymdf_key_35 UNIQUE (country, year, month, date, future)
        );
    ';

    col_list := 'id, session_number, year, month, date, day, captured_at, country, future, country_future, weight, '
        || 'bhs, wndw, last_price, session_ask, ask_size, session_bid, bid_size, '
