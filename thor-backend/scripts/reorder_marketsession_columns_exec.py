...
CREATE TABLE "FutureTrading_marketsession_new" (
    ...
    "market_high_drawdown_pct" numeric(14, 6),
...
SELECT
    ...
    volume, vwap, market_open, market_high_open, market_high_drawdown_pct,
    market_low_open, market_low_pct_open, market_close,
    market_high_pct_close, market_low_pct_close, market_close_vs_open_percentage,
